...
ثلاث أقسام: *الشريط الجانبي* على اليسار، *جدول البطاقات/الملحوظات* في أعلى اليمين،
...
يوفر أنكي 2.1.43+ وضعين لإظهار البطاقات والملحوظات في جدول البيانات.
تستطيع تغيير الوضع الحالي بالضغط على الزر في الأعلى، على يسار منطقة البحث،
أو بالضغط على <kbd>Alt</kbd>+<kbd>T</kbd>.
...
عنصر إلى البحث عنه. في أنكي 2.1.43+، يوفر الشريط أيضًا حقل بحث، وأدوات
...
يمكن جمع هذا مع بعض مفاتيح لوحة المفاتيح كما هو مشروح في قسم [أداة البحث](#أداة-البحث) لإضافة عبارة البحث الناتجة إلى عبارة البحث الحالية.

### عبارات البحث المحفوظة
...
من خلال قائمة زر الفأرة الأيمن، أو باستخدام اختصار  (<kbd>Del</kbd> and <kbd>F2</kbd> في ويندوز).
يعمل الحذف عند تحديد عناصر متعددة في الوقت نفسه أيضًا
(انظر [أداة التحديد](#أداة-التحديد)).
...
انظر قسم [التحرير والمزيد](studying.md#تحرير-والمزيد).
...
تتوفر كل العمودات في كل من [وضعي البطاقات والملحوظات](#أوضاع-الجدول)
لكن بأسماء وبيانات مختلفة قليلًا أحيانًا. يوضح الجدول التالي سلوك الوضعين.

| عمود | وضع البطاقات | موضع الملحوظات |
|-|-|-|
| الجواب | الجانب الخلفي للبطاقة بسطر واحد بدون جانب السؤال. تستطيع اختيار [صيغة مخصصة](templates/styling.md#مظهر-المتصفح) في محرر نوع البطاقة. | مثل وضع البطاقات، لكن للبطاقة الأولى من الملحوظة فقط. |
| البطاقة/البطاقات | اسم قالب البطاقة. | عدد بطاقات الملحوظة. |
| تاريخ تعديل البطاقة | تاريخ آخر مرة أجريت فيها تغييرات على __البطاقة__ (عندما راجعت البطاقة وتم تحديث تاريخ المراجعة والفواصل الزمنية مثلًا). | تاريخ آخر مرة أجريت فيها تغييرات على بطاقة من بطاقات الملحوظة. |
...
| سؤال | الجانب الأمامي للبطاقة في سطر واحد. تستطيع أيضًا اختيار [صيغة مخصصة](templates/styling.md#مظهر-المتصفح) في محرر نوع البطاقة. | مثل وضع البطاقات لكن للبطاقة الأولى من الملحوظة فقط. |
...
| اسم | إجراء
-|-|
| إضافة ملحوظات | يفتح نافذة [إضافة الملحوظات](editing#إضافة-بطاقات-وملحوظات). |
...
| إدارة أنواع الملحوظات | يفتح نافذة [الملحوظات](editing#إضافة-نوع-ملحوظة). |
...
| ضبط تاريخ الاستحقاق | ينقل البطاقات إلى آخر صف البطاقات الجديدة، أو يعيد جدولتها كبطاقات مراجعة في تاريخ محدد. الخيار الثاني مفيد إذا استوردت مواد درستها من قبل، وتريد البدء بها بفواصل أولية أعلى. مثلًا، اختيار 60 و 90 سيعطي كل البطاقات المستوردة فاصلًا أوليًا مكونًا من شهرين أو ثلاث. لا يُمسح سجل مراجعة البطاقة عند إعادة الجدولة: تغير إعادة الجدولة وضع البطاقة الحالي وليس سجلها. إذا كنت تريد إخفاء السجل، فسيتوجب عليك تصدير ملحوظاتك كملف نصي، وحذف الملحوظات، ثم استيراد الملف النصي مجددًا لإنشاء ملحوظات جديدة. |
| نسيان | ينقل البطاقات المحددة إلى صف البطاقات الجديدة، ويصفر سهولتها. يتم الاحتفاظ بسجل المراجعة. |
| تغيير الموضع | يغير ترتيب ظهور البطاقات الجديدة. تستطيع رؤية المواضع الحالية بتفعيل عمود *مستحقة*، كما هو مشروح في قسم قائمة [الجدول](#جدول-البطاقاتالملحوظات) في الأعلى. إذا اخترت خيار إعادة الموضعة عند تحديد عدة بطاقات، فسيتم إعطاء أعداد متصاعدة لكل بطاقة بالترتيب. يزداد العدد بواحد لكل بطاقة افتراضيًا، لكن يمكن تعديل هذا بتغيير إعداد «الخطوة». يسمح لك خيار *غير موضع البطاقات الموجودة* بوضع بطاقات بين البطاقات الموجودة حاليًا، مبعدًا البطاقات الموجودة أكثر. على سبيل المثال، إذا كان لديك 5 بطاقات وتريد نقل 3، 4،5 بين 1 و2، فتحديد هذا الخيار سيضع البطاقات بالترتيب 1، 3، 4، 5، 2. أما إذا أوقفت هذا الخيار، فالبطاقتان 1 و 2 ستأخذان رقم الموضع نفسه (وستظهر واحدة قبل الأخرى بشكل عشوائي). لاحظ أنه عند تفعيل الخيار، أي بطاقة بموضع أعلى سيتم تعديلها، وكل البطاقات المعدلة ستجب إعادة مزامنتها عند المزامنة القادمة.
| تفعيل/تعليق | [يعلّق](studying.md#تحرير-والمزيد) أو يفعل كل البطاقات المحددة، بناءً على ما إذا كانت البطاقة الحالية معلقة أم لا. |
...
| معلومات | يظهر معلومات منوعة عن البطاقة الحالية، بما في ذلك سجل مراجعتها. لمزيد من المعلومات، انظر قسم [معلومات البطاقة](stats.md#معلومات-البطاقة). |
