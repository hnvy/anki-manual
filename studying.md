...
تعليق البطاقة / الملحوظة  
يخفي البطاقة أو كل بطاقات الملحوظة من المراجعة إلى حين تفعيلها يدويًا.
...
عند تعليقها، ستُعاد إلى صف البطاقات الجديدة أو صف المراجعات قبل تعليقها.
