...
يدعم أنكي 2.1.45+ الحقول الثابتة (sticky fields) بدون إضافات.
إذا ضغطت على زر الدبوس على يسار حقل، فسيمسح أنكي محتوى الحقل بعد إضافة الملحوظة.
قد تجد هذا مفيدًا إذا لاحظت أنك تدخل المحتوى نفسه في ملحوظات متعددة.
يمكن تفعيل الحقول الثابتة وإيقافها من نافذة التحرير.
