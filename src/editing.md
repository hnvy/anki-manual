...
في أنكي، وتُنشأ البطاقات تلقائيًا. اضغط «إضافة» في [النافذة الرئيسية](studying.md#decks) لتظهر نافذة
إضافة ملحوظات.
...
[حقولًا](getting-started.md#notes--fields)، وبإمكانك إضافتها وحذفها وإعادة تسميتها بالضغط على زر «حقول...»
في الأعلى.
...
بشكل صحيح عند المراجعة، عليك تعديل [القالب](templates/styling.md#text-direction).
...
[الرزم](getting-started.md#decks) مصممة لتقسيم محتواك إلى أصناف ترغب في دراستها بشكل منفصل،
...
تستطيع إضافة الوسوم من شاشة التحرير و[المتصفح](browsing.md)،
حيث يمكنك إضافة الوسوم، وإعادة تسميتها، وتنظيمها هناك.
لاحظ أن الوسوم تعمل على مستوى [الملحوظات](getting-started.md#notes--fields)،
...
تعمل على مستوى [البطاقة](getting-started.md#cards)، لذلك فتأشير بطاقة لديها
...
<kbd>CTRL</kbd> + <kbd>1-7</kbd> في ويندوز أو <kbd>CMD</kbd> + <kbd>1-7</kbd> في ماك
ومن خلال [المتصفح](browsing.md).
...
تستطيع إنشاء رزم مؤقتة من مصطلحات البحث باستخدام [الدراسة المخصصة والرزم المفلترة](filtered-decks.md).
