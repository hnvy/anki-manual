...
أو هاتفك المحمول. انظر قسم [تنصيب الخطوط](#تنصيب-خطوط) لمزيد من المعلومات.
...
لتغيير اتجاه الحقول في المحرر، انظر قسم [التحرير](../editing.md#تخصيص-الحقول).
...
(التي تدعى «أمام» و «خلف») في [قائمة البطاقات](../browsing.md#جدول-البطاقاتالملحوظات).
...
انظر تعليمات [تنسيق الحقول](#تنسيق-الحقول) في الأعلى.
