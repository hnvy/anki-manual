...
المزامنة](https://www.youtube.com/watch?v=YkiM4DPzSVc&list=PLGgmaKOIHykFoomqkBJA
yGiDQ2kyiuTao&yt:cc=on).
...
يمكنك تعطيل المزامنة التلقائية من [تفضيلات](preferences.md#syncing) أنكي.
...
في [موقع الدعم](https://forums.أنكي ويب.net).
...
محلية أو [نسخة احتياطية](./backups.md).
