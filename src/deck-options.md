...
Log-loss ليس له تفسير بديهي. يمكن تفسير RMSE (bins) على أنها متوسط الفرق بين الاحتمال المتوقع لاستحضار البطاقة (R) والاحتمال المقاس (من سجل المراجعة). على سبيل المثال، RMSE=5% يعني أنه في المتوسط، يكون FSRS متوقفًا بنسبة 5% عند التنبؤ بـ R.
