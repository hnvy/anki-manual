...
تنطبق الإعدادات في هذا القسم على البطاقات الجديدة والبطاقات [في وضع التعلم](https://docs.ankiweb.net/studying.html?#بطاقات-التعلمإعادة-تعلم) الأولي فقط.
حالما تتخرج بطاقة (لم تتبق أي خطوات تعلم)، فستصبح [بطاقة مراجعة](https://docs.ankiweb.net/studying.html?#بطاقات-المراجعة)،
