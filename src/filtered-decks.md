# الرزم المفلترة والدراسة المكثفة {#filtered-decks--cramming}
...
## الخطوات والرجوع {#steps--returning}

انظر قسم [التعلم](studying.md#learningrelearning-cards) حول كيفية عمل الخطوات.
...
## المراجعات المستحقة {#due-reviews}
...
## المراجعة المبكرة {#reviewing-ahead}
