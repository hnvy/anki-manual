...
- إذا كان لديك عدة ملفات شخصية، تستطيع استخدام <span dir="ltr">-p &lt;اسم&gt;</span>
  لتشغيل ملف محدد.
- إذا أستخدمت -p اسمًا-مزيفًا، فسوف يعرض أنكي شاشة الملفات الشخصية عند بدء التشغيل. إذا لم يتم توفير ملف الشخصي، فسيتم تحميل مجلد الملف الشخصي الذي تم استخدامه آخر مرة.
