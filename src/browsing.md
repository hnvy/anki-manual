...
| إنشاء رزمة مفلترة | يظهر نافذة [الرزمة المفلترة](filtered-decks.md#إنشاء-يدوي) ويضبط بحث المتصفح الحالي كفلتر الرزمة. استخدم <kbd>Alt</kbd> / <kbd>Option</kbd> لضبط فلتر ثانٍ (يتطلب المجدول الإصدار 2). |
...
| اسم | إجراء
-|-|
| إضافة ملحوظات | يفتح نافذة [إضافة الملحوظات](editing.md#إضافة-بطاقات-وملحوظات). |
...
| إدارة أنواع الملحوظات | يفتح نافذة [الملحوظات](editing.md#إضافة-نوع-ملحوظة). |
