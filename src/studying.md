...
من خلال [خيارات الرزمة](deck-options.md#بطاقات-جديدة).
...
**جيد** ينقل البطاقة إلى [الخطوة التالية](deck-options.md#خطوات-التعلم). إذا كانت البطاقة في الخطوة الأخيرة،
...
تظهر البطاقة بعد 4 أيام، ثم بفواصل زمنية متزايدة [بشكل افتراضي](deck-options.md#فاصل-البطاقات-السهلة).
...
في هذه الحالة، يقال إن البطاقة قد «سقطت». انظر قسم [السقطات](deck-options.md#السقطات)
لمزيد من المعلومات حول كيفية التعامل مع المراجعات الساقطة.

**صعب** بشكل افتراضي، يظهر البطاقة بعد [فاصل زمني أكبر بقليل](deck-options.md#فاصل-البطاقات-الصعبة) من المرة الأخيرة،
ويخبر أنكي بإظهار البطاقة بوتيرة أكبر في المستقبل.

**جيد** يخبر أنكي أن الفاصل الزمني الأخير كان مناسبًا تقريبًا.
ولا حاجة لتعديل سهولة البطاقة. في [السهولة الابتدائية الافتراضية](deck-options.md#السهولة-الأولية)،
...
ستظهر البطاقة [متأخرة أكثر مما إذا اخترت «جيد»](deck-options.md#مكافأة-البطاقات-السهلة)، وستظهر مرات أقل أيضًا.
...
عندما تختار زر سهولة، يطبق أنكي مدة زمنية عشوائية قصيرة (تعرف بالـfuzz factor)،
...
- [**تأشير البطاقة**](editing.md#استخدام-المؤشرات): يضع مؤشر ملون على البطاقة، أو يزيله. تظهر المؤشرات أثناء الدراسة،
...
- **ضبط تاريخ الاستحقاق**: يجعل البطاقات بطاقات مراجعة، و[يجعلها مستحقة في تاريخ محدد](browsing.md#البطاقات).
...
- **معلومات البطاقة**: يعرض [بيانات إحصائية](stats.md#معلومات-البطاقة) عن البطاقة.

- [**تعليم الملحوظة**](editing.md#وسم-marked): يضع وسم “marked” للملحوظة الحالية لتسهيل إيجادها في نافذة المتصفح.
...
- في مجدول V1، عندما يكون للرزمة رزم فرعية، ستظهر البطاقات من كل رزمة [بالترتيب](studying.md#ترتيب-العرض).
...
البطاقات في ترتيب الرزمة أيضًا. انظر قسم [خيارات الرزمة](deck-options.md#ترتيب-فرز-المراجعات) لمزيد من المعلومات.
