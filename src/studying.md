...
تظهر البطاقة بعد 4 أيام، ثم بفواصل زمنية متزايدة [بشكل افتراضي](deck-options.md#الفاصل-الزمني-للبطاقات-السهلة).
...
**صعب** يظهر البطاقة بعد [فاصل زمني أكبر بقليل](deck-options.md#الفاصل-الزمني-للبطاقات-الصعبة) من المرة الأخيرة،
...
كما في البطاقات في طور التعلم، تستطيع استخدام المفاتيح `1`, `2`, `3` و `4` لاختيار جواب.
...
## عدد البطاقات المستحقة والعامل العشوائي
...
يضيف أنكي مدة زمنية عشوائية قصيرة لأوقات الاستحقاق التالية (تعرف بالـfuzz)،
لمنع البطاقات التي دُرسِت معًا وقُيِّمت بالتقييم نفسه من البقاء معًا دائمًا.
في مجدول V3، تُحسب هذه المدة مع الفواصل بجانب أزرار الإجابة.
