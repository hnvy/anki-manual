...
أو [تغيير خياراتها](deck-options.md)، أو [تصديرها](exporting.md).
...
- في مجدول V1، عندما يكون للرزمة رزم فرعية، ستظهر البطاقات من كل رزمة [بالترتيب](studying.md#display-order).
